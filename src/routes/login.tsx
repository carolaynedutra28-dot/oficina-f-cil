  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm rounded-xl border bg-card p-6 shadow-sm">
        <h1 className="text-2xl font-semibold text-card-foreground">Oficina Mecânica</h1>
        <p className="mt-2 text-sm text-muted-foreground">Digite a senha de acesso para continuar.</p>
